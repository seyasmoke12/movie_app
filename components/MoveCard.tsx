...
export default function MoveCard({id,poster_path,vote_average,release_date,title}:Movie) {
   ...
   <Link href={`/movies/${id}`} asChild>
    <TouchableOpacity className='w-[30%]'>
        ...
        <View className='flex-row items-center justify-between'>
            ...
            <Text className='text-xs font-medium text-light-300 uppercase mt-1 mr-2'>Movie</Text>
        </View>
    </TouchableOpacity>
   </Link>
  ) 
